...
**elaborateData**: Converts a Dictionary to a Table, you can see that when you import the Main Folder, there is a ModuleScript (Component) inside Components where you see that i am getting Data[1] and not Data['Text'] which is what i sent from the Plugin Script.
